...
In development and tests, embedded assets are disabled. The Go process serves API and optional gRPC ports, while the frontend apps run separately through the development tooling.
