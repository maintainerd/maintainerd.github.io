...
export const maintainerdServices = [
  ...
  },
  {
    ...
    summary: "Manage Kubernetes from the dashboard — a built-in cluster, or your connected EKS, AKS, or GKE.",
  ...
  },
  {
    ...
    summary: "Private container registry — run the built-in registry, or manage ECR, GCR, or ACR behind the scenes.",
    description: "Registry stores and serves the container images your Docker and Kubernetes workloads run. Use the built-in registry (on top of Harbor/Distribution) for on-prem, or point Registry at ECR, GCR, ACR, or any OCI registry and drive it from the same dashboard.",
    headline: "One registry surface — built-in on-prem, or your cloud's registry.",
    command: "docker pull maintainerd/maintainerd-registry",
    features: [
      "Built-in OCI registry, or connect ECR / GCR / ACR",
  ...
  },
  {
    ...
    summary: "Build and deploy pipelines — run built-in runners, or drive CodeBuild, Cloud Build, or GitHub Actions.",
    ...
    features: [
      ...
      "Built-in runners, or manage CodeBuild / Cloud Build / GitHub Actions",
  ...
  },
  {
    ...
    summary: "Provision and manage databases — the built-in engine, or your RDS, Cloud SQL, or Azure Database behind the scenes.",
  ...
  },
  {
    ...
    summary: "Managed cache and key-value — run the built-in Redis, or control ElastiCache or Memorystore behind the scenes.",
    description: "Cache provisions the fast key-value layer applications rely on for sessions, rate limits, and hot data. Run the built-in engine (on top of Redis) on your own hosts, or have Cache manage ElastiCache, Memorystore, or Azure Cache from the same dashboard.",
    headline: "One key-value surface — built-in Redis, or your cloud's cache.",
    command: "docker pull maintainerd/maintainerd-cache",
    features: [
      "Built-in Redis-compatible engine, or connect ElastiCache / Memorystore",
  ...
  },
  {
    ...
    summary: "Secrets and keys with encryption and rotation — the built-in vault, or your Secrets Manager, Key Vault, or GCP Secret Manager.",
  ...
  },
  {
    ...
    summary: "Routing, ingress, and service exposure — built-in Traefik/Caddy, or your cloud load balancer or API gateway.",
  ...
  },
  {
    ...
    summary: "Object storage, buckets, and signed URLs — built-in on MinIO, or your S3, GCS, or Azure Blob behind the scenes.",
  ...
  },
  {
    ...
    summary: "Email, SMS, and push with templates and delivery logs — built-in SMTP, or SES, SNS, Twilio, or SendGrid.",
  ...
  },
  {
    ...
    summary: "Logs, metrics, traces, and alerts — built-in Prometheus/Grafana/Loki, or your CloudWatch or Datadog.",
