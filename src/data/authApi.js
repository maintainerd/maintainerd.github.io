...
const endpoint = (method, path, summary, surface = internal, details = null) => ({
  method,
  path,
  summary,
  surface,
...
const responseEnvelope = "All REST setup responses use the shared JSON envelope. Success responses include success, data, and message. Error responses include success=false, error, and optional details.";

const commonSetupMutationResponses = [
  {
...
const setupDetails = {
  status: {
    ...
    headers: [acceptHeader, noAuthHeader],
  ...
  complete: {
    ...
    responses: [
      ...
      commonSetupMutationResponses[1],
      {
        status: "500 Internal Server Error",
  ...
  registerControlService: {
    ...
    headers: [jsonHeader, acceptHeader, noAuthHeader],
    requestBody: {
      type: "JSON object",
      description: "Service registration payload.",
      fields: [
        { name: "name", type: "string", required: true, description: "Unique service name. Use 2-100 letters, numbers, hyphens, underscores, or dots." },
        { name: "display_name", type: "string", required: true, description: "Human-readable service name, 2-100 characters." },
        { name: "description", type: "string", required: false, description: "Optional service description, up to 500 characters." },
        { name: "version", type: "string", required: false, description: "Optional version. Defaults to v1 when omitted. Use 1-50 letters, numbers, hyphens, underscores, or dots." },
        { name: "AllowedActions", type: "string[]", required: false, description: "Optional control-policy action list. Empty means the documented default control actions." },
        { name: "PolicyName", type: "string", required: false, description: "Optional policy name. Use when one Auth instance serves more than one orchestrator grant." }
      ],
      example: {
        name: "core",
  ...
  createTenant: {
    ...
    requestBody: {
      ...
      fields: [
        { name: "name", type: "string", required: true, description: "DNS-safe tenant slug, 3-63 characters. Lowercase letters, numbers, and hyphens only; must start and end with a letter or number." },
        { name: "display_name", type: "string", required: true, description: "Human-readable tenant name, 2-100 characters." },
        { name: "description", type: "string", required: false, description: "Optional tenant description, up to 200 characters." },
        { name: "metadata", type: "object", required: false, description: "Optional tenant metadata such as logo URL, favicon URL, language, timezone, date/time formats, privacy policy URL, and terms of service URL." },
        { name: "metadata.application_logo_url", type: "string", required: false, description: "Valid URL for the tenant logo, up to 500 characters." },
        { name: "metadata.favicon_url", type: "string", required: false, description: "Valid URL for the tenant favicon, up to 500 characters." },
        { name: "metadata.language", type: "string", required: false, description: "Language code such as en or en-US." },
        { name: "metadata.timezone", type: "string", required: false, description: "Timezone label, up to 50 characters." },
        { name: "metadata.privacy_policy_url", type: "string", required: false, description: "Valid privacy policy URL, up to 500 characters." },
        { name: "metadata.term_of_service_url", type: "string", required: false, description: "Valid terms of service URL, up to 500 characters." }
      ],
      example: {
        name: "maintainerd",
  ...
  createAdmin: {
    ...
    requestBody: {
      ...
      fields: [
        { name: "username", type: "string", required: true, description: "Admin username, 3-50 characters. Allows letters, numbers, underscore, hyphen, dot, and @." },
        { name: "email", type: "string", required: true, description: "Valid email address, up to 100 characters. Marked verified on creation." },
        { name: "password", type: "string", required: true, description: "Admin password, 8-100 characters, validated against the default password policy." },
        { name: "fullname", type: "string", required: false, description: "Optional full name. Defaults to username when omitted." }
      ],
      example: {
        username: "admin",
  ...
  createProfile: {
    ...
    requestBody: {
      ...
      fields: [
        ...
        { name: "middle_name", type: "string", required: false, description: "Optional middle name, up to 100 characters." },
        { name: "last_name", type: "string", required: false, description: "Optional last name, up to 100 characters." },
        { name: "suffix", type: "string", required: false, description: "Optional name suffix, up to 50 characters." },
        { name: "display_name", type: "string", required: false, description: "Optional display name, up to 100 characters." },
        { name: "birthdate", type: "string", required: false, description: "Calendar date in YYYY-MM-DD format." },
        { name: "gender", type: "string", required: false, description: "Allowed values: male, female, other, prefer_not_to_say." },
        { name: "bio", type: "string", required: false, description: "Optional biography, up to 1000 characters." },
        { name: "phone", type: "string", required: false, description: "Optional phone value, up to 20 characters." },
        { name: "email", type: "string", required: false, description: "Optional profile email, up to 255 characters." },
        { name: "address", type: "string", required: false, description: "Optional address, up to 500 characters." },
        { name: "city", type: "string", required: false, description: "Optional city, up to 100 characters." },
        { name: "country", type: "string", required: false, description: "Optional two-character ISO country code such as US or PH." },
        { name: "timezone", type: "string", required: false, description: "Optional timezone, up to 50 characters." },
        { name: "language", type: "string", required: false, description: "Optional language value, up to 10 characters." },
        { name: "profile_url", type: "string", required: false, description: "Optional valid URL for a profile image or profile page, up to 1000 characters." },
        { name: "metadata", type: "object", required: false, description: "Optional custom profile metadata." }
      ],
      example: {
...
export const apiGroups = [
  {
    ...
    endpoints: [
      endpoint("GET", "/setup/status", "Read whether setup is pending or already completed.", internal, setupDetails.status),
      endpoint("POST", "/setup/complete", "Mark the installation setup flow as completed.", internal, setupDetails.complete),
      endpoint("POST", "/setup/register-control-service", "Register the control-plane service during bootstrap.", internal, setupDetails.registerControlService),
      endpoint("POST", "/setup/create_tenant", "Create the first tenant during setup.", internal, setupDetails.createTenant),
      endpoint("POST", "/setup/create_admin", "Create the first administrator account.", internal, setupDetails.createAdmin),
      endpoint("POST", "/setup/create_profile", "Create the first administrator profile.", internal, setupDetails.createProfile)
    ]
  },
  {
    slug: "operations",
